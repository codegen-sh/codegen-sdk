...
class GetPRDataTool:
    ...
    def get_formatted_pr_data(self, pr_number_str: str) -> dict[str, Any]:
        ...
        return {
            "modified_symbols": [self.format_symbol_data(symbol) for symbol in modified_symbols],
            "context_symbols": [self.format_symbol_data(symbol) for symbol in context_symbols],
            "patch": patch,
        }
