...
mcp = FastMCP("codebase-agent-mcp", instructions="Use this server to access any information from your codebase. This tool can provide information ranging from AST Symbol details and information from across the codebase. Use this tool for all questions, queries regarding your codebase.")


@mcp.tool(name="query_codebase", description="Query your codebase for information about symbols, dependencies, files, anything")
def query_codebase(
    query: Annotated[str, "A question or prompt requesting information about or on some aspect of your codebase, for example 'find all usages of the method 'foobar', include as much information as possible"],
