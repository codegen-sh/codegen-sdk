...
class ViewFileTool(BaseTool):
    ...
    name: str = "view_file"
    description: str = "View the contents and metadata of a file in the codebase"
...
#     description: str = "List contents of a directory in the codebase"
...
#
#     name: str = "search"
#     description: str = "Search the codebase using text search"
...
#
#     name: str = "edit_file"
#     description: str = "Edit a file by replacing its entire content"
...
#
#     name: str = "commit"
#     description: str = "Commit any pending changes to disk"
#
#     def __init__(self, codebase: Codebase) -> None:
#         super().__init__()
#         self.codebase = codebase
...
#     description: str = "Reveal the dependencies and usages of a symbol up to N degrees"
#     args_schema: type[BaseModel] = RevealSymbolInput
#
#     def __init__(self, codebase: Codebase) -> None:
#         super().__init__()
#         self.codebase = codebase
...
#
#     name: str = "semantic_edit"
#     description: str = "Edit a file using a semantic edit specification with code blocks"
#     args_schema: type[BaseModel] = SemanticEditInput
#
#     def __init__(self, codebase: Codebase) -> None:
#         super().__init__()
#         self.codebase = codebase
...
#     description: str = "Rename a file and update all imports to point to the new location"
...
#     description: str = "Move a symbol from one file to another, with configurable import handling"
...
#     description: str = "Search the codebase using natural language queries and semantic similarity"
...
#
#     name: str = "create_pr"
#     description: str = "Create a PR for the current branch"
...
#
#     name: str = "get_pr_contents"
#     description: str = "Get the diff and modified symbols of a PR along with the dependencies of the modified symbols"
#     args_schema: type[BaseModel] = GetPRContentsInput
#
#     def __init__(self, codebase: Codebase) -> None:
#         super().__init__()
#         self.codebase = codebase
...
#     description: str = "Create a general comment on a pull request"
#     args_schema: type[BaseModel] = CreatePRCommentInput
#
#     def __init__(self, codebase: Codebase) -> None:
#         super().__init__()
#         self.codebase = codebase
...
#     description: str = "Create an inline review comment on a specific line in a pull request"
#     args_schema: type[BaseModel] = CreatePRReviewCommentInput
#
#     def __init__(self, codebase: Codebase) -> None:
#         super().__init__()
#         self.codebase = codebase
