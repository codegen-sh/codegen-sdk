...
from codegen_sdk.code_generation.doc_utils.canonicals import get_canonical_codemod_class_mdx, get_canonical_codemod_classes
from codegen_sdk.code_generation.doc_utils.skills import format_all_skills
from codegen_sdk.code_generation.doc_utils.utils import get_all_classes_to_document
from codegen_sdk.code_generation.mdx_docs_generation import render_mdx_for_codebase_page, render_mdx_page_for_class
from codegen_sdk.code_generation.prompts.api_docs import get_codegen_sdk_codebase
...
from codegen_sdk.skills.core.utils import get_all_skills, get_guide_skills_dict
...
def _generate_codebase_typestubs() -> None:
    ...
    os.system("uv run pyright -p . --createstub codegen_sdk.core.codebase")
