...
<Frame caption="Import loops in pytorch/torchgen/model.py">
    ...
    height="500px"
    scrolling="no"
    src={`https://www.codegen.sh/embedded/graph?id=ce2b4bee-fd40-4007-9540-f7ef18812d37&zoom=0.7`}
...
<Frame caption="Import loop in pytorch/torchgen/model.py">
    ...
    height="500px"
    scrolling="no"
    src={`https://www.codegen.sh/embedded/graph?id=f3cc5dbb-c577-4c80-991b-3a27f0fe9892&zoom=1`}
    className="rounded-xl "
    style={{
        backgroundColor: "#15141B",
    }}
