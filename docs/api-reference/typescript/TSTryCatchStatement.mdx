...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/adding-return-types/src/codegen/sdk/typescript/statements/try_catch_statement.py#L24-L93" />
