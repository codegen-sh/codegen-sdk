...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/adding-return-types/src/codegen/sdk/typescript/statements/labeled_statement.py#L22-L60" />
