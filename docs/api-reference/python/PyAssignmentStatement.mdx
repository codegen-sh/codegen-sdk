...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/adding-return-types/src/codegen/sdk/python/statements/assignment_statement.py#L25-L88" />
