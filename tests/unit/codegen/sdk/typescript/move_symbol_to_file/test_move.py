...
class TestMoveToFileImports:
    ...
    def test_keep_unused_imports(self, tmpdir) -> None:
        """Test that unused imports are kept when remove_unused_imports=False."""
        # language=typescript
        source_content = """
        import { helperUtil } from './utils';
        import { otherUtil } from './other';
        ...
        with get_codebase_session(tmpdir=tmpdir, programming_language=ProgrammingLanguage.TYPESCRIPT, files=files) as codebase:
            ...
            target_function = source_file.get_function("targetFunction")
            target_function.move_to_file(dest_file, include_dependencies=True, strategy="update_all_imports", remove_unused_imports=False)
    ...
    def test_used_imports_always_move(self, tmpdir) -> None:
        ...
        for remove_unused in [True, False]:
            with get_codebase_session(tmpdir=tmpdir, programming_language=ProgrammingLanguage.TYPESCRIPT, files=files) as codebase:
                ...
                target_function = source_file.get_function("targetFunction")
                target_function.move_to_file(dest_file, include_dependencies=True, strategy="update_all_imports", remove_unused_imports=remove_unused)
...
class TestMoveToFileDefaultExports:
    ...
    def test_back_edge_with_import_retention(self, tmpdir) -> None:
        ...
        with get_codebase_session(tmpdir=tmpdir, programming_language=ProgrammingLanguage.TYPESCRIPT, files=files) as codebase:
            ...
            target_function = source_file.get_function("targetFunction")
            target_function.move_to_file(dest_file, include_dependencies=True, strategy="add_back_edge", remove_unused_imports=True)
